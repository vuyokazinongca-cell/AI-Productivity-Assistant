  ...
  head: () => ({
    meta: [
      ...
      { title: "SimplyStyleByLerato | AI Business Assistant" },
      {
        name: "description",
        content:
          "AI business assistant for a beauty and wellness business: emails, meeting summaries, schedules, research and chat.",
      },
      { name: "author", content: "SimplyStyleByLerato" },
      { property: "og:title", content: "SimplyStyleByLerato | AI Business Assistant" },
      {
        property: "og:description",
        content: "Run your beauty and wellness business with AI-powered tools.",
      },
